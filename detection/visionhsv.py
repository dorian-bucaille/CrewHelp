...
# Used for object detection with OpenCV
class Vision:
    # constants
    ...
    @staticmethod
    def draw_rectangles(haystack_img, rectangles, line_color=(0, 255, 0)):
        line_type = cv.LINE_4
    ...
    @staticmethod
    def draw_crosshairs(haystack_img, points, marker_color=(255, 0, 255)):
